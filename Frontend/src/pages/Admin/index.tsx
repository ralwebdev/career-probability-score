                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="hidden sm:flex items-center gap-3">
                                        <Select value={selectedCollegeId} onValueChange={setSelectedCollegeId}>
                                            <SelectTrigger className="w-[240px] bg-card/50 backdrop-blur-sm border-primary/20 focus:ring-primary/30">
                                            ...
                                            <SelectContent>
                                                ...
                                                {colleges.map((college) => (
                                                    <SelectItem key={college._id} value={college.collegeId}>
                                                        {(college.name.length > 25
                                                            ? college.name.substring(0, 18) + "..."
